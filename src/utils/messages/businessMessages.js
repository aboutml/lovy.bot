...
export const getBizRegistrationSteps = {
  name: '📝 <b>Крок 1/6: Назва закладу</b>\n\nЯк називається твій бізнес?',
  category: '📝 <b>Крок 2/6: Категорія</b>\n\nОбери категорію свого бізнесу:',
  city: '📝 <b>Крок 3/6: Місто</b>\n\nВ якому місті знаходиться твій бізнес?',
  address: '📝 <b>Крок 4/6: Адреса</b>\n\nВкажи адресу (вулиця, номер будинку):',
  social: '📝 <b>Крок 5/6: Соціальні мережі</b>\n\nНадішли посилання на Instagram, Facebook або іншу соц. мережу:\n<i>(наприклад: https://instagram.com/your_business)</i>',
  photo: '📝 <b>Крок 6/6: Фото закладу</b>\n\nНадішли фото свого закладу або логотип.\n\n<i>Можеш пропустити цей крок:</i>',
};
